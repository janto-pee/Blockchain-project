...
const Welcome = () => {
  ...
  return (
    <div className='overflow-hidden'>
      <div className="flex flex-col md:flex-row items-center gap-6 py-12 md:py-20 justify-between">
        <div className='w-full md:basis-1/2 lg:basis-7/12 flex justify-between items-center text-center md:text-start relative'>
          <div className='md:basis-full lg:basis-4/6 '>
            ...
            <h1 className='text-3xl md:hidden font-semibold text-white mt-2 '>Buy and Sell Cryptocurrency</h1>
            <p className="text-gray-500 mt-3 mb-6 md:max-w-sm">Lorem ipsum dolor sit amet</p>
            {
          ...
          <div >
            <img src={toke} alt="" className='hidden lg:flex absolute top-[-5rem] right-[-3.8rem] w-4/6' />
          </div>
        </div>
        <div className='w-full md:basis-1/2 lg:basis-4/12 flex flex-col'>
          ...
          <div className="bg-gray-200 px-2 mt-2 rounded-md mx-auto">
            ...
            <Button buttonClass={'px-6 py-3 bg-primaryColor text-white mb-2 font-semibold w-full hover:bg-sky-300'} buttonName={'Send Now'} btnClick={handleSend} />
          </div>
        </div>
      </div>
    </div>
