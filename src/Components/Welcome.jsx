...
const Welcome = () => {
  ...
  return (
    <div className='overflow-hidden'>
      <div className="flex flex-col md:flex-row items-center gap-6 py-10 md:py-20 justify-between ">
        <div className='w-full md:basis-1/2 lg:basis-7/12 flex justify-between items-center text-center md:text-start relative'>
          <div className='md:basis-6/6'>
            <small className='text-amber-200'>TRUSTED CRYPTOS</small>
            <h1 className='hidden md:block text-5xl font-semibold text-white md:mt-4 mt-2 '>Buy and Sell Cryptos</h1>
            <h1 className='text-3xl md:font-semibold md:text-4xl md:hidden md:font-semibold text-white mt-2 '>Buy and Sell Cryptocurrency</h1>
          ...
          <div>
            <img src={hero} alt="" className='hidden lg:flex absolute top-[-5rem] right-[-3.8rem] w-4/6' />
          </div>
        </div>
