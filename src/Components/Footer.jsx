...
const Footer = () => {
  return (
    <footer className="border-t-2 mt-12 text-center ">
        ...
        <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-400 sm:mt-0 justify-center md:justify-right ">
            <li>
